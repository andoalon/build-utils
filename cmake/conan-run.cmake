...
function(_conan_get_profile_or_settings
	...
	if (profile OR (profile_host AND profile_build))
		if (profile)
			...
			set(${out_profile_or_settings} PROFILE ${profile_arg} PARENT_SCOPE)
		else()
			...
			set(${out_profile_or_settings} PROFILE_HOST ${profile_host_arg} PROFILE_BUILD ${profile_build_arg} PARENT_SCOPE)
		endif()
	else()
		conan_cmake_autodetect(conan_autodetected_settings BUILD_TYPE "${config}")
		set(${out_profile_or_settings} SETTINGS_HOST ${conan_autodetected_settings} SETTINGS_BUILD ${conan_autodetected_settings} PARENT_SCOPE)
	endif()
endfunction()
